...
const Hero = () => {
    return (
        <section id="hero" className="bg-white w-full px-4 md:px-16 lg:px-20 mt-16 pt-10 md:pt-11 flex flex-col-reverse lg:flex-row justify-end lg:justify-center items-center gap-10 lg:gap-36 min-h-[calc(100vh-80px)] w-full">
